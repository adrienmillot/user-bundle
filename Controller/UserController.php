...
class UserController extends AbstractController
{
    ...
    public function show(Security $prmSecurity, UserInterface $user): Response
    {
        $connectedUser = $prmSecurity->getUser();

        if ($connectedUser !== $user && !$prmSecurity->isGranted('ROLE_ADMIN')) {
            throw new \Exception('Your not allowed to see this page.');
        }
